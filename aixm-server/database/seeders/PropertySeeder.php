...
class PropertySeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $ref_feature_id = Feature::getFeature('Note')?->id; Property::create(['feature_id'=>$feature_id, 'name' => 'annotation', 'ref_feature_id' => $ref_feature_id]);
        $ref_feature_id = Feature::getFeature('AirportHeliport')?->id; Property::create(['feature_id'=>$feature_id, 'name' => 'airportHeliport', 'is_identifying' => true, 'ref_feature_id' => $ref_feature_id, 'is_xlink' => true]);
        $ref_feature_id = Feature::getFeature('Fuel')?->id; Property::create(['feature_id'=>$feature_id, 'name' => 'fuelSupply', 'is_identifying' => true, 'ref_feature_id' => $ref_feature_id, 'description' => 'choice - object identification issue']);
        $ref_feature_id = Feature::getFeature('Oil')?->id; Property::create(['feature_id'=>$feature_id, 'name' => 'oilSupply', 'is_identifying' => true, 'ref_feature_id' => $ref_feature_id, 'description' => 'choice - object identification issue']);
        $ref_feature_id = Feature::getFeature('Nitrogen')?->id; Property::create(['feature_id'=>$feature_id, 'name' => 'nitrogenSupply', 'is_identifying' => true, 'ref_feature_id' => $ref_feature_id, 'description' => 'choice - object identification issue']);
        $ref_feature_id = Feature::getFeature('Oxygen')?->id; Property::create(['feature_id'=>$feature_id, 'name' => 'oxygenSupply', 'is_identifying' => true, 'ref_feature_id' => $ref_feature_id, 'description' => 'choice - object identification issue']);
        ...
        $ref_feature_id = Feature::getFeature('TouchDownLiftOff')?->id; Property::create(['feature_id'=>$feature_id, 'name' => 'connectedTouchDownLiftOff', 'is_identifying' => true, 'ref_feature_id' => $ref_feature_id, 'is_xlink' => true, 'description' => 'choice']);
        $ref_feature_id = Feature::getFeature('RunwayCentrelinePoint')?->id; Property::create(['feature_id'=>$feature_id, 'name' => 'connectedRunwayCentrelinePoint', 'is_identifying' => true, 'ref_feature_id' => $ref_feature_id, 'is_xlink' => true, 'description' => 'choice']);
        $ref_feature_id = Feature::getFeature('Apron')?->id; Property::create(['feature_id'=>$feature_id, 'name' => 'connectedApron', 'is_identifying' => true, 'ref_feature_id' => $ref_feature_id, 'is_xlink' => true, 'description' => 'choice']);
        $ref_feature_id = Feature::getFeature('AircraftStand')?->id; Property::create(['feature_id'=>$feature_id, 'name' => 'connectedStand', 'is_identifying' => true, 'ref_feature_id' => $ref_feature_id, 'is_xlink' => true, 'description' => 'choice']);
        ...
        $ref_feature_id = Feature::getFeature('Taxiway')?->id; Property::create(['feature_id'=>$feature_id, 'name' => 'connectedTaxiway', 'is_identifying' => true, 'ref_feature_id' => $ref_feature_id, 'is_xlink' => true, 'description' => 'choice']);
        $ref_feature_id = Feature::getFeature('Note')?->id; Property::create(['feature_id'=>$feature_id, 'name' => 'annotation', 'ref_feature_id' => $ref_feature_id]);
        ...
        $ref_feature_id = Feature::getFeature('AirportHeliport')?->id; Property::create(['feature_id'=>$feature_id, 'name' => 'pointChoice_airportReferencePoint', 'ref_feature_id' => $ref_feature_id, 'is_xlink' => true]);
        $ref_feature_id = Feature::getFeature('TouchDownLiftOff')?->id; Property::create(['feature_id'=>$feature_id, 'name' => 'pointChoice_aimingPoint', 'ref_feature_id' => $ref_feature_id, 'is_xlink' => true]);
        $ref_feature_id = Feature::getFeature('RunwayCentrelinePoint')?->id; Property::create(['feature_id'=>$feature_id, 'name' => 'pointChoice_runwayPoint', 'ref_feature_id' => $ref_feature_id, 'is_xlink' => true]);
        $ref_feature_id = Feature::getFeature('Point')?->id; Property::create(['feature_id'=>$feature_id, 'name' => 'pointChoice_position', 'ref_feature_id' => $ref_feature_id]);
        $ref_feature_id = Feature::getFeature('Navaid')?->id; Property::create(['feature_id'=>$feature_id, 'name' => 'pointChoice_navaidSystem', 'ref_feature_id' => $ref_feature_id, 'is_xlink' => true]);
        $ref_feature_id = Feature::getFeature('DesignatedPoint')?->id; Property::create(['feature_id'=>$feature_id, 'name' => 'pointChoice_fixDesignatedPoint', 'ref_feature_id' => $ref_feature_id, 'is_xlink' => true]);
